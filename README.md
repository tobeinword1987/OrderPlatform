...
These endpoints are the most risky: Payments, create order and authorization.

Evidences are added to the ./security-evidence folder as the screenshots

All description and notes are in SECURITY-BASELINE.md

The most hard part to add was audit logging, for it was added at the end of the implementation. But it is one of the most important things, because it really helps to find the problem and to recreate history, to understand the possible reason of error.
