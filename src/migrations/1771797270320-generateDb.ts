...
export class GenerateDb1771797270320 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum" AS ENUM('created', 'updated', 'in_progress', 'closed')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e9df80f734de6a00462f6d516b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9891f07b0cac0cd80fb0694d31"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."Index_users_login_password_unique"`);
