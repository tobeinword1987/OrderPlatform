...
export class GenerateDb1771454274298 implements MigrationInterface {
    name = 'GenerateDb1771454274298'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "Index_scope_unique" ON "scope" ("scope") `);
        ...
        await queryRunner.query(`CREATE TYPE "order_status_enum" AS ENUM('created', 'updated', 'in_progress', 'closed')`);
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "idempotency_key" character varying NOT NULL, "delivery_address" character varying NOT NULL, "order_status" "order_status_enum" NOT NULL DEFAULT 'created', "user_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "Index_role_unique" ON "role" ("role") `);
        ...
        await queryRunner.query(`CREATE TABLE "role_to_scope" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role_id" uuid NOT NULL, "scope_id" uuid NOT NULL, CONSTRAINT "PK_5ed81971bf751473fa5ec8120fb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "Index_role_scope_unique" ON "role_to_scope" ("role_id", "scope_id") `);
        await queryRunner.query(`CREATE TABLE "audit_log" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "log" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_07fefa57f7f5ab8fc3f52b3ed0b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "role_scopes_scope" ("roleId" uuid NOT NULL, "scopeId" uuid NOT NULL, CONSTRAINT "PK_696ec3bec6b38875b26b1f0f44f" PRIMARY KEY ("roleId", "scopeId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9891f07b0cac0cd80fb0694d31" ON "role_scopes_scope" ("roleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e9df80f734de6a00462f6d516b" ON "role_scopes_scope" ("scopeId") `);
        ...
        await queryRunner.query(`ALTER TABLE "role_to_scope" ADD CONSTRAINT "FK_462460162c40f3277e7cdef419a" FOREIGN KEY ("role_id") REFERENCES "role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "role_scopes_scope" ADD CONSTRAINT "FK_9891f07b0cac0cd80fb0694d311" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "role_scopes_scope" ADD CONSTRAINT "FK_e9df80f734de6a00462f6d516b1" FOREIGN KEY ("scopeId") REFERENCES "scope"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE TABLE "configurable-table-query-result-cache" ("id" SERIAL NOT NULL, "identifier" character varying, "time" bigint NOT NULL, "duration" integer NOT NULL, "query" text NOT NULL, "result" text NOT NULL, CONSTRAINT "PK_21a78ca157d92cebb96c8ff9f01" PRIMARY KEY ("id"))`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE "configurable-table-query-result-cache"`);
        await queryRunner.query(`ALTER TABLE "role_scopes_scope" DROP CONSTRAINT "FK_e9df80f734de6a00462f6d516b1"`);
        await queryRunner.query(`ALTER TABLE "role_scopes_scope" DROP CONSTRAINT "FK_9891f07b0cac0cd80fb0694d311"`);
        await queryRunner.query(`ALTER TABLE "user_roles_role" DROP CONSTRAINT "FK_4be2f7adf862634f5f803d246b8"`);
        await queryRunner.query(`ALTER TABLE "user_roles_role" DROP CONSTRAINT "FK_5f9286e6c25594c6b88c108db77"`);
        await queryRunner.query(`ALTER TABLE "role_to_scope" DROP CONSTRAINT "FK_462460162c40f3277e7cdef419a"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_e9df80f734de6a00462f6d516b"`);
        await queryRunner.query(`DROP INDEX "IDX_9891f07b0cac0cd80fb0694d31"`);
        ...
        await queryRunner.query(`DROP INDEX "Index_audit_log_created_at"`);
        await queryRunner.query(`DROP TABLE "audit_log"`);
        await queryRunner.query(`DROP INDEX "Index_role_scope_unique"`);
        await queryRunner.query(`DROP TABLE "role_to_scope"`);
        await queryRunner.query(`DROP TABLE "user_role"`);
        await queryRunner.query(`DROP INDEX "Index_role_unique"`);
        await queryRunner.query(`DROP TABLE "role"`);
        await queryRunner.query(`DROP INDEX "Index_users_email_unique"`);
        await queryRunner.query(`DROP INDEX "Index_users_login_unique"`);
        await queryRunner.query(`DROP INDEX "Index_users_login_password_unique"`);
        await queryRunner.query(`DROP TABLE "user"`);
        await queryRunner.query(`DROP INDEX "Index_order_user_id"`);
        await queryRunner.query(`DROP INDEX "Index_order_created_at"`);
        await queryRunner.query(`DROP INDEX "Index_idempotency_key_unique"`);
        await queryRunner.query(`DROP TABLE "order"`);
        await queryRunner.query(`DROP TYPE "order_status_enum"`);
        await queryRunner.query(`DROP INDEX "Index_order_item_order_id"`);
        await queryRunner.query(`DROP INDEX "Index_order_item_product_id"`);
        await queryRunner.query(`DROP TABLE "order_item"`);
        await queryRunner.query(`DROP INDEX "Index_product_price"`);
        await queryRunner.query(`DROP INDEX "Index_product_category_id"`);
        await queryRunner.query(`DROP TABLE "product"`);
        await queryRunner.query(`DROP TABLE "category"`);
        await queryRunner.query(`DROP INDEX "Index_scope_unique"`);
